...
It can be very useful when we need transform data into another format and have referenced as varaible.
...
[Provisioner_local-exec](https://developer.hashicorp.com/terraform/language/resources/provisioners/local-exec)
...
```
[Provisioner_remote-exec](https://developer.hashicorp.com/terraform/language/resources/provisioners/remote-exec)
